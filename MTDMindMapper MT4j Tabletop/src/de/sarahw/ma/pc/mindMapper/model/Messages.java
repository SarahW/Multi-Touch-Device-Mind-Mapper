...
/**
 * Messages class handling the external string resources for the model.
 * 
 * @author Sarah Will
 * 
 * @version 1.0
...
public class Messages {
    ...
    private static final String         BUNDLE_NAME     = "de.sarahw.ma.pc.mindMapper.model.messages"; //$NON-NLS-1$
     ...
     * 
     * @return the String from the String resources
     */
