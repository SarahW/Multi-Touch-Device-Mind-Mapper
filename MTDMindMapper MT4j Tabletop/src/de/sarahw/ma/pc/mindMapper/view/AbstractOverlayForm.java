 ...
 * button for closing the overlay, a headline text field editable MTTextField.
 * Concrete list edit field content/behaviour must be added by an implementing
 * subclass.
 * </p>
 * 
 * 
...
public abstract class AbstractOverlayForm extends AbstractOverlay {

    protected static Logger        log                                                = Logger.getLogger(AbstractOverlayForm.class);
    ...
    public static final float      OVERLAY_WIDTH_DEFAULT                              = 645.0f;

    /** The maximum overlay height in pixels * 2 */
    public static final float      OVERLAY_HEIGHT_DEFAULT                             = 394.0f;

    /** The overlay width in percent of the application width */
    public static final float      OVERLAY_WIDTH_SCALE_TO_APP_PERCENT                 = 0.16796875f;

    // OLD VALUES:
    // public static final float OVERLAY_WIDTH_DEFAULT = 484.0f;
    // public static final float OVERLAY_HEIGHT_DEFAULT = 296.0f;
    // public static final float OVERLAY_WIDTH_SCALE_TO_APP_PERCENT = 0.126041f;

    /* *** Overlay background constants *** */
    /** The overlay background image file path */
    private static final String    OVERLAY_BG_IMG_PATH                                = MT4jSettings
                                                                                              .getInstance()
                                                                                              .getDefaultSVGPath()
                                                                                              + "OverlayForm_BgPlain.svg";          //$NON-NLS-1$
    ...
    private static final float     OVERLAY_BG_WIDTH_OFFSET_TO_OVERLAY_PERCENT         = 0.0103305f;
     ...
     * overlay width
     */
    private static final float     OVERLAY_HANDLE_TOUCH_POINT_SHIFT_TO_CENTER_PERCENT = 0.04289f;

    /** The overlay handle width in percent of the overlay width */
    private static final float     OVERLAY_HANDLE_WIDTH_TO_OVERLAY_PERCENT            = 0.18595f;
    ...
    private static final float     BUTTON_CLOSE_WIDTH_SCALE_TO_OVERLAY_PERCENT        = 0.128099f;
    ...
    private static final float     HEADLINE_HEIGHT_SCALE_TO_OVERLAY_PERCENT           = 0.25f;
    /** The headline x offset in percent of the overlay width */
    private static final float     HEADLINE_X_OFFSET_TO_OVERLAY_PERCENT               = 0.07644f;
    ...
    /* *** Overlay form text field constants *** */
    /** The overlay form text field width in percent of the overlay width */
    private static final float     FORM_TEXTFIELD_WIDTH_TO_OVERLAY_PERCENT            = 0.845f;
    /** The overlay form text field height in percent of the overlay height */
    private static final float     FORM_TEXTFIELD_HEIGHT_TO_TFW_PERCENT               = 0.2272f;
    /** The overlay form text field x offset in percent of the overlay width */
    private static final float     FORM_TEXT_FIELD_X_OFFSET_PERCENT                   = 0.076446f;
    /** The overlay form text field y offset in percent of the overlay height */
    private static final float     FORM_TEXT_FIELD_Y_OFFSET_PERCENT                   = 0.31481f;

    /**
     * The overlay form text field inner padding top in percent of the overlay
     * width
     */
    private static final float     FORM_TEXT_FIELD_INNER_PADDING_TOP_PERCENT          = 0.05f;
    /**
     * The overlay form text field inner padding left in percent of the overlay
     * width
     */
    private static final float     FORM_TEXT_FIELD_INNER_PADDING_LEFT_PERCENT         = 0.02f;

    /** The overlay form text field font file name */
    public static final String     FORM_TEXTFIELD_FONT_FILE_NAME                      = "SansSerif";                                //$NON-NLS-1$

    /** The overlay form text field font size */
    public static final int        FORM_TEXTFIELD_FONT_SIZE                           = 24;
    // OLD VALUE:
    // public static final int FORM_TEXTFIELD_FONT_SIZE = 20;

    /** The overlay form text field fill color */
    private static final MTColor   FORM_TEXTFIELD_FILL_COLOR                          = MindMapperColors.DARK_GREY;
    /** The overlay form text field stroke color */
    private static final MTColor   FORM_TEXTFIELD_STROKE_COLOR                        = MindMapperColors.BLACK_SLIGHT_TRANS;
    /** The overlay form text field font color */
    private static final MTColor   FORM_TEXTFIELD_FONT_COLOR                          = MindMapperColors.BROKEN_WHITE;

    /** The overlay form text field style info */
    private static final StyleInfo FORM_TEXTFIELD_STYLE_INFO                          = new StyleInfo(
                                                                                              FORM_TEXTFIELD_FILL_COLOR,
                                                                                              FORM_TEXTFIELD_STROKE_COLOR,
                                                                                              true,
                                                                                              false,
                                                                                              false,
                                                                                              1.0f,
    ...
    /* *** Form *** */
    /** The form text field */
    private MTTextField            formTextField;
    /** The form font */
    private IFont                  formDefaultFont;

    /* ***********Constructors*********** */
    /**
     * Constructor. Instantiates a new AbstractOverlayForm.
     * 
     * @param pApplet
     ...
     */
    public AbstractOverlayForm(PApplet pApplet, float x, float y, float width,
            float height, IFont headlineFont, IFont formDefaultFont) {
        super(pApplet, x, y, width, height);

        log.debug("Executing AbstractOverlayForm(pApplet=" + pApplet + ", x=" //$NON-NLS-1$ //$NON-NLS-2$
                + x + ", y=" + y + ", width=" + width + ", height=" //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                + height + ", headlineFont=" + headlineFont //$NON-NLS-1$
                + ", formDefaultFont=" + formDefaultFont + ")"); //$NON-NLS-1$ //$NON-NLS-2$

        // Set app reference and fonts
        this.mtApplication = (AbstractMTApplication) pApplet;
        this.headlineFont = headlineFont;
        this.formDefaultFont = formDefaultFont;
    ...
    /* ********Getters & Setters******** */
    /**
     * Returns the north east touch point for the AbstractOverlayForm calculated
     * at initialization.
     * 
    ...
    /**
     * Returns the south east touch point for the AbstractOverlayForm calculated
     * at initialization.
     * 
    ...
    /**
     * Returns the south west touch point for the AbstractOverlayForm calculated
     * at initialization.
     * 
    ...
    /**
     * Returns the north west touch point for the AbstractOverlayForm calculated
     * at initialization.
     * 
    ...
    /**
     * Returns the overlay MTTextFieldWithCheck instance.
     * 
     * @return the formTextField
     */
    public MTTextField getFormTextField() {
    ...
    /**
     * Returns the form default font.
     * 
     * @return the formDefaultFont
     */
    public IFont getFormDefaultFont() {
        return this.formDefaultFont;
    }

    /* **********Object methods********** */
    /**
     * Initializes a new AbstractOverlayDefaultList
     * 
     */
    ...
    /**
     * Adds a background MTSvg image to the AbstractOverlayDefaultList.
     * 
     */
    private void addBackground() {
        ...
        // circle)
        MTSvg background = new MTSvg(this.mtApplication, OVERLAY_BG_IMG_PATH);
        ...
        if (this.hasBounds()) {
            ...
            if (this.headlineFont != null) {
                ...
                textField.translate(new Vector3D(overlayWidth
                        * HEADLINE_X_OFFSET_TO_OVERLAY_PERCENT, 0, 0));
    ...
    /**
     * Adds an emtpy form text field to the AbstractOverlayForm. To be filled by
    ...
    private void addFormTextField() {
        ...
        if (this.hasBounds()) {
            ...
            if (this.formDefaultFont != null) {
                ...
                // Create new list
                MTTextField formTextField = new MTTextField(
                        this.mtApplication,
                ...
                // Remove all default gesture listeners
                ToolsEventHandling
                        .removeScaleProcessorsAndListeners(formTextField);
                ToolsEventHandling
                        .removeDragProcessorsAndListeners(formTextField);
                ToolsEventHandling
                        .removeRotateProcessorsAndListeners(formTextField);

                // Set padding
                formTextField.setInnerPaddingLeft((new Float(formTextField
                        .getWidthXY(TransformSpace.GLOBAL)
                        * FORM_TEXT_FIELD_INNER_PADDING_LEFT_PERCENT))
                        .intValue());
                formTextField.setInnerPaddingTop((new Float(formTextField
                        .getWidthXY(TransformSpace.GLOBAL)
                ...
                formTextField.translate(new Vector3D(overlayWidth
                        * FORM_TEXT_FIELD_X_OFFSET_PERCENT, overlayHeight
                        * FORM_TEXT_FIELD_Y_OFFSET_PERCENT, 0));

                // Set member
                this.formTextField = formTextField;

            } else {
                log.error("Error! The form default font specified at initialization is invalid! (null)"); //$NON-NLS-1$
            }
    ...
    /**
     * <p>
     * Shows a disappearing animation and closes the AbstractOverlay instance.
     * </p>
     * 
     * 
     * <p>
            ...
            public void processAnimationEvent(AnimationEvent ae) {
                switch (ae.getId()) {
                    ...
                    case AnimationEvent.ANIMATION_ENDED:
                        ...
                        // Set AbstractOverlayDefaultList instance invisible and
                        // destroy
                        setVisible(false);
                        destroy();
