 ...
 * 
 */
public abstract class AbstractOverlayDefaultList extends AbstractOverlay {

    protected static Logger        log                                                = Logger.getLogger(AbstractOverlayDefaultList.class);
    ...
    public static final float      OVERLAY_WIDTH_MAX                                  = 496.0f;
    /** The maximum overlay height in pixels * 2 */
    public static final float      OVERLAY_HEIGHT_MAX                                 = 645.0f;
    /** The overlay width in percent of the application width */
    public static final float      OVERLAY_WIDTH_SCALE_TO_APP_PERCENT                 = 0.12916666f;

    // OLD VALUES:
    // public static final float OVERLAY_WIDTH_MAX = 372.0f;
    // public static final float OVERLAY_HEIGHT_MAX = 484.0f;
    // public static final float OVERLAY_WIDTH_SCALE_TO_APP_PERCENT = 0.09687f;
    ...
    private static final float     OVERLAY_BG_WIDTH_OFFSET_TO_OVERLAY_PERCENT         = 0.014784f;
     ...
     * overlay width
     */
    private static final float     OVERLAY_HANDLE_TOUCH_POINT_SHIFT_TO_CENTER_PERCENT = 0.0526315f;

    /** The overlay handle width in percent of the overlay width */
    private static final float     OVERLAY_HANDLE_WIDTH_TO_OVERLAY_PERCENT            = 0.241935f;
     ...
     */
    private static final float     BUTTON_CLOSE_X_OFFSET_FROM_TPNE_PERCENT            = 0.384615f;
    /**
     * The close button y offset from the touch point north east in percent of
     * the close button width
     */
    private static final float     BUTTON_CLOSE_Y_OFFSET_FROM_TPNE_PERCENT            = 0.384615f;

    /** The close button width in percent of the overlay width */
    private static final float     BUTTON_CLOSE_WIDTH_SCALE_TO_OVERLAY_PERCENT        = 0.13978f;

    /* *** Headline constants *** */
    /** The headline width in percent of the overlay width */
    private static final float     HEADLINE_WIDTH_SCALE_TO_OVERLAY_PERCENT            = 0.65f;
    /** The headline height in percent of the overlay height */
    private static final float     HEADLINE_HEIGHT_SCALE_TO_OVERLAY_PERCENT           = 0.165289f;
    /** The headline x offset in percent of the overlay width */
    private static final float     HEADLINE_X_OFFSET_TO_OVERLAY_PERCENT               = 0.10f;

    /** The headline font size */
    public static final int        HEADLINE_FONT_SIZE                                 = 20;
    // OLD VALUE:
    // public static final int HEADLINE_FONT_SIZE = 16;
    ...
    private static final float     LIST_WIDTH_SCALE_TO_OVERLAY_PERCENT                = 0.7983f;
    /** The overlay content list height in percent of the overlay height */
    private static final float     LIST_HEIGHT_SCALE_TO_OVERLAY_PERCENT               = 0.76859f;
    /** The overlay content list x offset in percent of the overlay width */
    private static final float     LIST_X_OFFSET_TO_OVERLAY_PERCENT                   = 0.10f;
    /** The overlay content list x offset in percent of the overlay height */
    private static final float     LIST_Y_OFFSET_TO_OVERLAY_PERCENT                   = 0.15371f;
    ...
    public static final int        LIST_CONTENT_FONT_BIG_SIZE                         = 22;
    // OLD VALUE:
    // public static final int LIST_CONTENT_FONT_BIG_SIZE = 19;
    ...
    /* ***********Constructors*********** */
    /**
     * Constructor. Instantiates a new AbstractOverlayDefaultList.
     * 
     * @param pApplet
     ...
     */
    public AbstractOverlayDefaultList(PApplet pApplet, float x, float y,
        ...
        log.debug("Executing AbstractOverlayDefaultList(pApplet=" + pApplet + ", x=" //$NON-NLS-1$ //$NON-NLS-2$
    ...
    /* ********Getters & Setters******** */
    /**
     * Returns the north east touch point for the AbstractOverlayDefaultList
    ...
    /**
     * Returns the south east touch point for the AbstractOverlayDefaultList
     * calculated at initialization.
     * 
    ...
    /**
     * Returns the south west touch point for the AbstractOverlayDefaultList
     * calculated at initialization.
     * 
    ...
    /**
     * Returns the north west touch point for the AbstractOverlayDefaultList
     * calculated at initialization.
     * 
    ...
    /**
     * Sets the overlay list
     * 
     * @param overlayList
     *            the overlayList to set
     */
    public void setOverlayList(MTList overlayList) {
    ...
    private void addHeadlineTextField() {
        ...
        if (this.hasBounds()) {
            ...
            if (this.headlineFont != null) {
                ...
                // Set padding
                textField.setInnerPaddingLeft((new Float(
                        HEADLINE_INNER_PADDING_LEFT_PERCENT
                                * textField.getWidthXY(TransformSpace.GLOBAL)))
                        .intValue());
                textField.setInnerPaddingTop((new Float(
                        HEADLINE_INNER_PADDING_TOP_PERCENT
                                * textField.getWidthXY(TransformSpace.GLOBAL)))
                        .intValue());
     ...
     * @param width
     *            the width
     * @return true, if width greater 0
     * 
    ...
    /**
     * <p>
     * Shows a disappearing animation and closes the AbstractOverlayDefaultList
     * instance.
     * </p>
     * 
     * 
