...
/**
 * <p>
 * The Class DragProcessorIdeaNodeView. For multi touch drag behaviour on
 * IdeaNodeView components. Fires DragEvent gesture events, but only if the
 ...
 * 
 */
public class DragProcessorIdeaNodeView extends DragProcessor {

    private static Logger log = Logger.getLogger(DragProcessorIdeaNodeView.class);
     ...
     * 
     */
    public DragProcessorIdeaNodeView(PApplet graphicsContext) {
                ...
                if (target instanceof MTComponent
                    ...
                    if (curComp instanceof IdeaNodeView) {
                        ...
                        if (curComp.getParent() != null) {
                            ...
                            } else if ((comp instanceof IdeaNodeView)
                                    || (comp instanceof NodeContentContainer)
